...
class TestHierarcher(unittest.TestCase):
    ...
    def test_should_raise_ArgumentTypeError_from_incorrect_text_input(self):
        ...
        self.assertEqual(
            str(ex.exception),
            "Sorry, this does not seem like a valid input format. See README.",
        )

    def test_should_raise_ArgumentTypeError_on_provided_not_supported_file_extension(
        self,
    ):
        # GIVEN
        self.args["input_text"] = None
        ...
        self.args["input_text"] = {
            "employer": {
                ...
                "reports": [
                    ...
                    {"employer": {"name": "Cory", "salary": 65000, "reports": []}},
                ],
            }
        }
